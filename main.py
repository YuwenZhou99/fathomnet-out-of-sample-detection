...
class Config:
    # paths
    label_csv: str = "multilabel_classification/train.csv"
    coco_train_json: str = "object_detection/train.json"  # contains coco_url with dive_id
    category_key_csv: str = "category_key.csv"
    image_dir: str = "train"  # folder with uuid.png
